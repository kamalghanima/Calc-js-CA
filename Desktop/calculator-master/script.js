...
const dollerToSh = document.querySelector('#doller-to-sh');
const shToDoller = document.querySelector('#sh-to-doller');
const euToSh = document.querySelector('#eu-to-sh');
const shToEu = document.querySelector('#sh-to-eu');
